...
public class ResumoPacoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        carregPacoteRecebido();


    }

    private void carregPacoteRecebido() {
    ...
    private void mostraData(Pacote pacote) {
        ...
        String dataFormatadaDaVaigem = DataUtil.preiodoEmTexto(pacote.getDias());
        data.setText(dataFormatadaDaVaigem);
    }


    private void mostraPreco(Pacote pacote) {
        TextView preco = findViewById(R.id.resumo_pacote_preco);
        String moedaBrasileira = MoedaUtil.formataParaBrasileito(pacote.getPreco());
